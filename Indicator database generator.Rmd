...
for(t in c("All","PECES","MOLUSCOS","CRUSTÁCEOS")){
  ...
  for(P in c(0,1,2)){
    ...
    for(d in c("All","Slope","Shelf")){
      ...
      if(ProblemSpecies==1){setwd("D:/Dropbox/Tesis Carlos Veloy/Scripts Carlos/Results/WestMed/Without problematic species/Points")}
      else{ setwd("D:/Dropbox/Tesis Carlos Veloy/Scripts Carlos/Results/WestMed/With problematic species/Points")}
...
for(t in c("All","PECES","MOLUSCOS","CRUSTÁCEOS")){
  ...
  for(P in c(0,1,2)){
    print(P)
   {
      ...
      tax<-switch(TaxType,"PECES" = "Fish","CRUSTÁCEOS" = "Crustaceans","MOLUSCOS" = "Molluscs")
      pel<-switch(P+1,"Benthics","Pelagics","All")
      if(ProblemSpecies==1){setwd("D:/Dropbox/Tesis Carlos Veloy/Scripts Carlos/Results/WestMed/Without problematic species/Sectors")}
      else{ setwd("D:/Dropbox/Tesis Carlos Veloy/Scripts Carlos/Results/WestMed/With problematic species/Sectors")}
      Indicators_table$Pelagics<-switch(P+1,"Benthics","Pelagics","All")
      Indicators_table$Taxa<-TaxType
...
a<-switch(ProblemSpecies+1,"With problematic species","Without problematic species")
  ...
  pointdatdir<-paste("D:/Dropbox/Tesis Carlos Veloy/Scripts Carlos/Results/WestMed/",a,"/Points",sep="")
